    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
                <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm prose prose-blue max-w-none">
                    <a href="/" className="inline-flex items-center text-blue-600 hover:text-blue-800 mb-6 no-underline font-semibold">
                        ← Back to Home
                    </a>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to VadalurCommercialSpaces.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to VadalurCommercialSpaces, accessible from <a href="https://VadalurCommercialSpaces.netlify.app" rel="external nofollow noopener noreferrer" target="_blank">VadalurCommercialSpaces.netlify.app</a>.</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By visiting this page on our website: <a href="https://VadalurCommercialSpaces.netlify.app" rel="external nofollow noopener noreferrer" target="_blank">VadalurCommercialSpaces.netlify.app</a></li>
                    </ul>
                </div>
            </main>
            <Footer />
